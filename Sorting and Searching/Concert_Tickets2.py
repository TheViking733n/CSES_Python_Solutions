# Not my code - https://cses.fi/problemset/hack/1091/entry/2382443/
...
hs = SortedList(values)
ts = [int(x) for x in data[2].split()]
 
solution = []
for t in ts:
    my_index = hs.bisect_right(t) - 1
    if my_index >= 0:
        value = hs.pop(my_index)
